...
public class CreationCommande extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (form.getErreurs().isEmpty()) {
			...
			Map<String, Commande> commandes = (HashMap<String, Commande>) context
					.getAttribute(StaticStrings.COMMANDE_CONTEXT_NAME_MAP);
			...
			this.getServletContext().getRequestDispatcher(StaticStrings.COMMANDE_VIEW_CREATE).forward(request,
					response);
		}
	}
}